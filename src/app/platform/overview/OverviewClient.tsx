...
export default function OverviewClient() {
  return (
    <main className="min-h-screen bg-[var(--color-bg)] text-[var(--color-text)]">
      ...
      {/* Navigation & CTA */}
      <section className="w-full bg-[var(--color-bg)] px-6 py-14 sm:px-10 sm:py-16">
        <div className="mx-auto w-full max-w-6xl">
          <div className="rounded-3xl border border-[var(--color-border)] bg-[var(--color-surface)] p-8 shadow-[0_20px_50px_var(--color-card-shadow)]">
            <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
              <div className="space-y-2">
                <h3 className="text-2xl font-semibold tracking-tight text-[var(--color-text)]">
                  Explore Capabilities &amp; Get In Touch
                </h3>
                <p className="max-w-2xl text-sm text-[var(--color-muted)] sm:text-base">
                  Discover our full suite of core capabilities or speak directly with our engineering team regarding your project scope.
                </p>
              </div>
              <div className="flex flex-wrap items-center gap-4">
                ...
                >
                  Platform Features &rarr;
                </Link>
                <Link
                  href="/contact/"
                  className="inline-flex items-center justify-center rounded-full bg-[var(--color-primary)] px-6 py-3 text-sm font-semibold text-[var(--color-on-primary)] transition-colors duration-300 hover:opacity-90"
                >
                  Contact Us
                </Link>
                <Link
